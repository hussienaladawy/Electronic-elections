        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('admin.elections.candidates.edit', [$election->id, $candidate->id]) }}" class="btn btn-warning">{{ __('Edit') }}</a>
                        <a href="{{ route('admin.elections.candidates', $election->id) }}" class="btn btn-secondary">{{ __('Back to Candidates') }}</a>
                        
                        <form method="POST" action="{{ route('admin.elections.candidates.destroy', [$election->id, $candidate->id]) }}" style="display: inline-block;" onsubmit="return confirm('Are you sure you want to delete this candidate?')">
                            @csrf
                            @method('DELETE')
