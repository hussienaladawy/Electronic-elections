    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('super_admin.elections.candidates.store', $election->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-primary">اضافة المرشح</button>
                        <a href="{{ route('super_admin.elections.candidates', $election->id) }}" class="btn btn-secondary">الغاء</a>
                    </form>
                </div>
            </div>
        </div>
