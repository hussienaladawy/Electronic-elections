    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.elections.candidates.update', [$election->id, $candidate->id]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <a href="{{ route('admin.elections.candidates', $election->id) }}" class="btn btn-secondary">{{ __('Cancel') }}</a>
                    </form>
                </div>
            </div>
        </div>
