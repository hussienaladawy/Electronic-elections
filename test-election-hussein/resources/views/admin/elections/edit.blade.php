    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route("admin.elections.update", $election->id ?? 1) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
...
<div class="mb-3">
    ...
    @enderror
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <a href="{{ route("admin.elections.show", $election->id ?? 1) }}" class="btn btn-info">
