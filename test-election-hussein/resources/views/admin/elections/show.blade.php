        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route("admin.elections.edit", $election->id ?? 1) }}" class="btn btn-warning btn-sm">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route("admin.elections.candidates", $election->id ?? 1) }}" class="btn btn-primary btn-sm">
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <a href="{{ route("admin.elections.candidates", $election->id ?? 1) }}" class="btn btn-primary">
                                إضافة مرشحين
                            </a>
                        </div>
                    @endif
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route("admin.elections.candidates", $election->id ?? 1) }}" class="btn btn-info btn-sm">
                            <i class="fas fa-users mr-1"></i>
                            إدارة المرشحين
                        </a>
                        
                        <a href="{{ route("admin.elections.results", $election->id ?? 1) }}" class="btn btn-primary btn-sm">
...
function changeElectionStatus(electionId, status) {
    ...
    if (confirm(`هل أنت متأكد من ${statusText[status]} هذه الانتخابات؟`)) {
        fetch(`{{ route("admin.elections.change-status", "") }}/${electionId}`, {
            method: "POST",
            headers: {
...
function deleteElection(electionId) {
    if (confirm("هل أنت متأكد من حذف هذه الانتخابات؟ هذا الإجراء لا يمكن التراجع عنه.")) {
        fetch(`{{ route("admin.elections.destroy", "") }}/${electionId}`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
                "X-CSRF-TOKEN": document.querySelector("meta[name="csrf-token"]").getAttribute("content")
