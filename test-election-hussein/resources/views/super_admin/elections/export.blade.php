    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route("super_admin.elections.export") }}" method="GET">
                        <div class="mb-3">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route("super_admin.elections.export") }}?format=csv&quick=all" class="btn btn-outline-primary btn-sm">
                            <i class="fas fa-file-csv mr-1"></i>
                            تصدير جميع الانتخابات (CSV)
                        </a>
                        <a href="{{ route("super_admin.elections.export") }}?format=xlsx&quick=active" class="btn btn-outline-success btn-sm">
                            <i class="fas fa-file-excel mr-1"></i>
                            تصدير الانتخابات النشطة (Excel)
                        </a>
                        <a href="{{ route("super_admin.elections.export") }}?format=pdf&quick=completed" class="btn btn-outline-info btn-sm">
